...
" git commit messages indentation
...
" Go fmt
" run gofmt check every time you write a golang file
autocmd BufWritePost *.go call Fmt
...
"go
autocmd FileType go nnoremap <buffer> . .<C-x><C-o>
